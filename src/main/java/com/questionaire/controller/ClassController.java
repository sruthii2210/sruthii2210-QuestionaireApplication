...
public class ClassController {
	...
	public ResponseEntity<Response> updateClass(@PathVariable("roomNo") Long roomNo,
		...
		try {
			...
			responseEntity = ResponseUtil.getResponse(200, "ClassDetails updated for roomNo " + roomNo + " !",
					updatedClass);
	...
	public ResponseEntity<Response> getClass(@PathVariable("standard") String standard,
